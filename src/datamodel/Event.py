...
class EventCategory(Enum):
    ...
    Procedures = EventCategoryValue('procedures',
...
class Event:
    ...
    def __hash__(self):
        return hash((self.category, tuple(self.codes), self.max_occurrence, self.occurrence_within_encounter,
                     self.negation, self.include_subcodes, self.exclusion_period, tuple(self.exclusion_events),
                     tuple(self.having_events), self.having_period, self.period))
