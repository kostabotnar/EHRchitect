...
from src.datamodel.ExperimentConfig import ExperimentEvent, ExperimentTimeInterval, AttributeEventMode
...
class Event:
    ...
    def from_experiment_event(experiment_event: ExperimentEvent) -> Optional[Event]:
        ...
        if experiment_event.exclude and experiment_event.exclude.events:
            ...
            excl_mode = AttributeMode.from_attr_event_mode(experiment_event.exclude.mode)
        else:
            excl_period = None
            excl_events = None
